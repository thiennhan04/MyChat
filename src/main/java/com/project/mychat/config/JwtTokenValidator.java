    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (jwt != null){
            try{
                ...
                String authorities = String.valueOf(claim.get("authoritíe"));
                List<GrantedAuthority> auths = List.of((GrantedAuthority) AuthorityUtils.commaSeparatedStringToAuthorityList(authorities));
